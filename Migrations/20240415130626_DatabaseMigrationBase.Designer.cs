...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CheckSkillsASP.Entity.AppRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("CheckSkillsASP.Entity.AppUserRole", b =>
                {
            ...
            modelBuilder.Entity("CheckSkillsASP.Entity.AppUserRole", b =>
                {
                    b.HasOne("CheckSkillsASP.Entity.AppRole", "Role")
                        .WithMany("UserRoles")
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("CheckSkillsASP.Entity.AppUser", "User")
                        .WithMany("UserRoles")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("CheckSkillsASP.Entity.AppRole", null)
                        .WithMany()
                        .HasForeignKey("RoleId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
